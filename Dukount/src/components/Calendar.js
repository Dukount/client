...
import { dateAction } from "../actions/calendarAction";
...
class CalenderClass extends Component<{}>{
  ...
  render () {
    // console.log('===WorkDay===',this.state.dateSelected);
    // console.log('===HomeDay===',this.state.dateUnselected);
    return (
      <View>
